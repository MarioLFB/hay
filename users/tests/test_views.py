...
class RegisterViewTest(TestCase):
    ...
    def test_register_success(self):
        ...
        # Send POST request to the 'register' view with valid registration data
        response = self.client.post(self.url, data)

        # Assert that the HTTP status code of the response is 302 (Redirect)
        self.assertEqual(response.status_code, 302)

        # After successful registration, view redirects to the 'login' page
        ...
        # Assert that there is exactly one message
        self.assertEqual(
            str(messages[0]),
...
class LoginViewTest(TestCase):
    ...
    def test_login_success(self):
        ...
        # After successful login, the view redirects to the 'home' page
...
class LogoutViewTest(TestCase):
    ...
    def test_logout_success(self):
        ...
        # After successful logout, the view redirects to the 'home' page
        self.assertRedirects(response, reverse('home'))
